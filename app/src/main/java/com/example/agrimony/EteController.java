...
import com.example.agrimony.EteRadioGroup;
...
public class EteController {
    ...
    public EteController(Activity activity) {
    ...
    private void onConfirmButtonClicked() {
        ...
        model.fetchRecommendedCulture("été", recommendedCulture, new CultureModel.OnCultureDataListener() {
            @Override
    ...
    private void onOtherButtonClicked() {
        Intent dialogIntent = new Intent(activity, EteRadioGroup.class);
        activity.startActivityForResult(dialogIntent, REQUEST_CODE_DIALOG);
    }

    public void handleActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE_DIALOG && resultCode == Activity.RESULT_OK && data != null) {
