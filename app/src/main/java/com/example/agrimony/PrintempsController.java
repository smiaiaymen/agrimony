...
import com.example.agrimony.PrintempsRadioGroup;
import com.example.agrimony.R;

import java.util.Map;

public class PrintempsController {
    private Activity activity;
    private CultureModel model;
    private TextView recommendationTextView;
    private Button confirmButton, otherButton;

    private static final int REQUEST_RADIO_GROUP = 2;

    public PrintempsController(Activity activity) {
    ...
    private void onConfirmButtonClicked() {
        ...
        model.fetchRecommendedCulture("printemps", recommendedCulture, new CultureModel.OnCultureDataListener() {
            @Override
    ...
    private void onOtherButtonClicked() {
        Intent dialogIntent = new Intent(activity, PrintempsRadioGroup.class);
